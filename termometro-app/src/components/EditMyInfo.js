...
function EditMyInfo({ token, history }) {
    ...
    return (
        <section className='editMemberContainer'>
          ...
          {!userInfo && <img className='editMemberContainer__spinner' src={spinner}></img>}
            {userInfo && <h1 className='editMemberContainer__title'>¡Aquí tienes la oportunidad de editar tus datos!</h1>}
